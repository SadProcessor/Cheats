...
#### Path from A to B_- any Edge type_
```
MATCH
...
#### Path from A to B_- specific Edge types_
```
MATCH
(A:User {name: 'ACHAVARIN@EXTERNAL.LOCAL'}),
(B:Group {name: 'DOMAIN ADMINS@INTERNAL.LOCAL'}),
