...
see also [Neo4j Syntax Reference](http://neo4j.com/docs/cypher-refcard/current/) for more Cypher madness
...
- **Slack** 
[Channel](https://bloodhoundhq.slack.com/messages/general/) get invite [here](https://bloodhoundgang.herokuapp.com/)
...
---
### Sample DB
Want to play with the Puppy but don't have an AD at hand? Install the supplied sample DB.
...
- set db name to mount to `dbms.active_database=BloodHoundExampleDB.graphdb`
...
For automated BloodHound install script check [here](link) _(windows64 only)_
<br><br/>
<br><br/>
---
### KeyBoard Shortcuts
